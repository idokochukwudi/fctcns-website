...
echo "Ì¥ß COMPREHENSIVE FIX"
echo "==================="

echo "1. Fixing admin/index.php routes..."
# Create a completely fresh admin/index.php with correct syntax
cat > app/views/admin/index.php.fixed << 'ADMINFIX'
<?php
/**
...
// SPECIAL HANDLING FOR applications/view/{id} and applications/edit/{id}
$route_key = $action;
...
mv app/views/admin/index.php.fixed app/views/admin/index.php
echo "‚úÖ Created clean admin/index.php with correct syntax"

echo ""
echo "2. Fixing e() function duplication..."
# Simple fix: Remove the duplicate e() function from home.php
if [ -f "app/views/pages/home.php" ]; then
    # Create a simple sed command to comment out the function
    sed -i '/^function e()/,/^}/s/^/\/\//' app/views/pages/home.php
    echo "‚úÖ Commented out e() function in home.php"
fi

echo ""
echo "3. Final verification..."
echo "Checking admin/index.php syntax:"
php -l app/views/admin/index.php 2>/dev/null || echo "‚ö†Ô∏è  Syntax check failed"

echo ""
echo "Ì≥ã READY TO TEST!"
echo "1. Homepage: http://localhost/fctcns-website/"
echo "2. Admin Dashboard: http://localhost/fctcns-website/admin/dashboard"
echo "3. Applications Edit: http://localhost/fctcns-website/admin/applications/edit/1"

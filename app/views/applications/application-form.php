 ...
 * 
 * @package FCTCNS
 * @version 3.0 - Security Enhanced + Full-width layout
 */
...
class ApplicationFormStep2View {
    use SecurityTrait;
    ...
    public function render($data) {
        ...
        <head>
            ...
            <!-- ========================================================= -->
            <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600;700&family=Outfit:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap" 
                  rel="stylesheet"
        ...
        <body>
                                                        ...
                                                        <div class="existing-file">
                                                            <div class="existing-file-header">
                                                                ...
                                                                <div class="existing-file-actions">
                                                                    <a href="<?php echo e($existing_passport['file_path']); ?>" target="_blank" class="existing-file-btn" title="View" rel="noopener noreferrer">
                                                            ...
                                                            <ul class="existing-file-list">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="d-flex gap-2">
                                                                        <a href="<?php echo e($file['file_path']); ?>" target="_blank" class="existing-file-btn" title="View" rel="noopener noreferrer">
                                                                            <i class="fas fa-eye"></i> View
                                                                        </a>
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                                    ...
                                                    <span class="text-success d-flex align-items-center gap-2 flex-wrap">
                                                        ...
                                                        <a href="<?php echo e($existing_jamb_result['file_path']); ?>" target="_blank" class="existing-file-btn" title="View" rel="noopener noreferrer">
                                                            <i class="fas fa-eye"></i> View
                                                        </a>
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                                    ...
                                                    <span class="text-success d-flex align-items-center gap-2 flex-wrap">
                                                        ...
                                                        <a href="<?php echo e($existing_birth_certificate['file_path']); ?>" target="_blank" class="existing-file-btn" title="View" rel="noopener noreferrer">
                                                            <i class="fas fa-eye"></i> View
                                                        </a>
            ...
            // ======================================================
            // Application Form JavaScript with Security Enhancements
            // ======================================================
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (!jambData || !jambVerified) {
                    ...
                    const appData = {
                        jamb_number: '<?php echo addslashes($application['jamb_number'] ?? ''); ?>',
                        first_name: '<?php echo addslashes($application['first_name'] ?? ''); ?>',
                        last_name: '<?php echo addslashes($application['last_name'] ?? ''); ?>',
                        other_names: '<?php echo addslashes($application['other_names'] ?? ''); ?>',
                        gender: '<?php echo addslashes($application['gender'] ?? ''); ?>',
                        state_of_origin: '<?php echo addslashes($application['state_of_origin'] ?? ''); ?>',
                        lga: '<?php echo addslashes($application['lga'] ?? ''); ?>',
                        score: '<?php echo addslashes($application['utme_score'] ?? ''); ?>'
                    };
...
// =========================================================
$view = new ApplicationFormStep2View();

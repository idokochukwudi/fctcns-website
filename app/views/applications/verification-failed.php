...
class JambVerificationFailedView {
    use SecurityTrait;
    ...
    public function render($data) {
        ...
        <head>
            ...
            <title>JAMB Verification Failed - FCT College of Nursing Sciences</title>
        ...
        <body>
                    ...
                    <div class="verify-failed-body">
                        ...
                        <div class="error-message">
                            ...
                            <div class="jamb-number-highlight">
                                <?php echo $this->e($jamb_number ?? 'Unknown'); ?>
                            </div>
            ...
            // ======================================================
            // JAMB Verification Failed JavaScript with Security Enhancements
            // ======================================================
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (retryBtn) {
                    retryBtn.addEventListener('click', function(e) {
                        ...
                        if (getCsrfToken()) {
                            fetch('/api/track-verification-failed', {
                                method: 'POST',
                                headers: {
                                ...
                                body: JSON.stringify({
                                    action: 'jamb_verification_failed_retry',
                                    jamb_number: '<?php echo $this->e($jamb_number ?? ''); ?>',
                                    timestamp: Date.now()
                                })
                            }).catch(() => {}); // Silent fail
                        }
                ...
                document.querySelectorAll('.action-card').forEach(card => {
                    card.addEventListener('click', function(e) {
                        const action = this.querySelector('h5')?.textContent || 'unknown';
                        ...
                        if (getCsrfToken()) {
                            fetch('/api/track-action', {
                                ...
                                body: JSON.stringify({
                                    action: 'verification_failed_quick_action',
                                    quick_action: action,
                                    timestamp: Date.now()
                                })
                            }).catch(() => {});
...
// =========================================================
$view = new JambVerificationFailedView();

...
$rootPath = dirname(__DIR__, 4); // Go up 3 levels from app/views/admin/research/
...
// Load Research Model
require_once APP_PATH . '/models/ResearchModel.php';
$researchModel = new ResearchModel();

// Get categories for dropdown
$categories = $researchModel->getCategories();

// Get flash messages and old input
...
$defaults = [
    'title' => $old_input['title'] ?? '',
    'authors' => $old_input['authors'] ?? '',
    'abstract' => $old_input['abstract'] ?? '',
    'keywords' => $old_input['keywords'] ?? '',
    'publication_type' => $old_input['publication_type'] ?? 'journal',
    'journal_name' => $old_input['journal_name'] ?? '',
    'volume' => $old_input['volume'] ?? '',
    'issue' => $old_input['issue'] ?? '',
    'pages' => $old_input['pages'] ?? '',
    'publisher' => $old_input['publisher'] ?? '',
    'publication_date' => $old_input['publication_date'] ?? date('Y-m-d'),
    'doi' => $old_input['doi'] ?? '',
    'url' => $old_input['url'] ?? '',
    'research_area' => $old_input['research_area'] ?? '',
    'citations' => $old_input['citations'] ?? 0,
    'impact_factor' => $old_input['impact_factor'] ?? '',
    'is_published' => $old_input['is_published'] ?? 0,
    'is_featured' => $old_input['is_featured'] ?? 0
];
...
<head>
    ...
    <title>Add New Publication - FCT College of Nursing Sciences</title>
    <style>
        /* CSS Variables */
        :root {
            ...
            <div class="sidebar-footer">
                <div class="user-profile">
                    ...
                    <div class="user-info">
                        ...
                        <span><?php echo ucfirst($userRole); ?> - Research</span>
                    </div>
                </div>
            </div>
        </aside>
        ...
        <main class="main-content">
            ...
            <header class="page-header">
                <div class="page-header-content">
                    <h1 class="page-title">Add New Publication</h1>
                                ...
                                <div class="grid-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="citations" name="citations"
                                               value="<?php echo htmlspecialchars($defaults['citations']); ?>" min="0">
                                    </div>
                            ...
                            <div class="form-card">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="is_published" name="is_published" value="1"
                                        <?php echo $defaults['is_published'] ? 'checked' : ''; ?>>
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="is_featured" name="is_featured" value="1"
                                        <?php echo $defaults['is_featured'] ? 'checked' : ''; ?>>

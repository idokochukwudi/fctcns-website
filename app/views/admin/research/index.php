...
<body>
            ...
            <?php if (!empty($research)): ?>
                <table>
                    ...
                    <tbody>
                        ...
                        <tr data-category="<?php echo htmlspecialchars($pub['category_slug'] ?? $pub['research_area'] ?? ''); ?>"
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    <!-- FIXED VIEW LINK -->
                                    <a href="<?php echo BASE_URL; ?>/admin/research/view/<?php echo $pub['id']; ?>" 
                                       class="action-btn action-view">View</a>
                                    
                                    <?php if (in_array($userRole, ['admin', 'editor']) && 
                                             ($pub['created_by'] == $currentUserId || $userRole == 'admin')): ?>
                                    <a href="<?php echo BASE_URL; ?>/admin/research/edit/<?php echo $pub['id']; ?>"  
    ...
    <script>
        ...
        function initializeCategoryFiltering() {
            ...
            if (categoryButtons.length === 0 || tableRows.length === 0) {
                console.log('No category buttons or table rows found');
                return;
            }
            ...
            document.querySelectorAll('.category-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    tableRows.forEach(row => {
                        ...
                        console.log('Row category:', rowCategory, 'Matches?', rowCategory === category);
                    ...
                    updateFilteredStats(category, visibleCount);
                });
            });
        }

        function updateFilteredStats(category, visibleCount) {
            // Update the "All Categories" count if needed
            if (category === 'all') {
                const allCategoriesBtn = document.querySelector('.category-btn[data-category="all"] .count');
                if (allCategoriesBtn) {
                    allCategoriesBtn.textContent = visibleCount;
                }
            }
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Also add click event to the "Categories" toggle button if it exists
            const categoriesToggleBtn = document.querySelector('button[onclick*="toggleCategories"]');
            if (categoriesToggleBtn) {
                categoriesToggleBtn.addEventListener('click', function() {
                    // Re-initialize filters when categories section is shown
        ...
        function clearCategoryFilter() {
            ...
            console.log('Filter cleared, showing all', rows.length, 'rows');
        }
        ...
        function exportResearch() {
            ...
            window.location.href = '<?php echo BASE_URL; ?>/admin/research/export';
        }
        ...
        document.addEventListener('click', function(e) {
            ...
            // Remove the old alert for action-view since it's now a proper link

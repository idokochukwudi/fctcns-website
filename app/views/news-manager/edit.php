...
$pageTitle = 'Edit ' . ($type === 'event' ? 'Event' : 'News Article');
$icon = $type === 'event' ? 'fa-calendar-edit' : 'fa-edit';
            ...
            <div class="container-fluid">
                ...
                <div class="meta-info-bar">
                    <div class="meta-info-item">
                        ...
                        <span class="meta-info-label">ID:</span>
                        <span class="meta-info-value">#<?php echo $news['id']; ?></span>
                    </div>
                    <div class="meta-info-item">
                        <i class="fas fa-user"></i>
                        <span class="meta-info-label">Author:</span>
                        <span class="meta-info-value"><?php echo htmlspecialchars($news['author_name'] ?? 'Unknown'); ?></span>
                    </div>
                    <div class="meta-info-item">
                        <i class="fas fa-calendar-alt"></i>
                        <span class="meta-info-label">Created:</span>
                        <span class="meta-info-value"><?php echo isset($createdDate) ? $createdDate : 'N/A'; ?></span>
                    </div>
                    <div class="meta-info-item">
                        <i class="fas fa-eye"></i>
                        <span class="meta-info-label">Views:</span>
                        <span class="meta-info-value"><?php echo number_format($news['views_count'] ?? 0); ?></span>
                    </div>
                    <div class="meta-info-item">
                    ...
                    <div class="meta-info-item">
                        <a href="<?php echo $baseUrl; ?>/news/<?php echo $news['slug']; ?>" target="_blank" class="view-link">
                ...
                <div class="info-box">
                    ...
                    <p>
                        <strong>Editing:</strong> You are editing "<?php echo htmlspecialchars($news['title']); ?>". 
                        Fill in the required fields marked with <span style="color: var(--danger);">*</span>. 
                ...
                <!-- Main Form -->
                <form method="POST" action="<?php echo $baseUrl; ?>/admin/news-manager/update/<?php echo $news['id']; ?>" 
                    ...
                    <div class="form-header">
                        <h2>
                            <i class="fas <?php echo $icon; ?>"></i>
                            <?php echo $type === 'event' ? 'Edit Event' : 'Edit News Article'; ?>
                        </h2>
                        <p>Update the details for your <?php echo $type === 'event' ? 'event' : 'news article'; ?> below</p>
                    </div>
                        ...
                        <div class="tab-content active" id="tab-content">
                            <div class="form-grid">
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <div class="char-count" id="titleCount"><?php echo strlen($news['title']); ?>/200</div>
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <div class="char-count" id="excerptCount"><?php echo strlen($news['excerpt']); ?>/300</div>
                                </div>
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <div class="current-image" id="current-image">
                                        ...
                                        <div class="current-image-info">
                                            ...
                                            <p class="image-path"><?php echo htmlspecialchars($news['featured_image']); ?></p>
                                ...
                                <div class="checkbox-group">
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="is_published" id="is_published" 
                                               value="1" <?php echo ($news['is_published'] ?? 0) ? 'checked' : ''; ?>>
                                        <label for="is_published">Published</label>
                                    </div>
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="is_featured" id="is_featured" 
                                               value="1" <?php echo ($news['is_featured'] ?? 0) ? 'checked' : ''; ?>>
                                        <label for="is_featured">Featured</label>
                                    </div>
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="is_breaking" id="is_breaking" 
                                               value="1" <?php echo ($news['is_breaking'] ?? 0) ? 'checked' : ''; ?>>
                ...
                <!-- Delete Form (separate for security) -->
                <?php if ($canDelete ?? false): ?>
                <form method="POST" id="deleteForm" action="<?php echo $baseUrl; ?>/admin/news-manager/delete/<?php echo $news['id']; ?>" style="display: none;">
                    <input type="hidden" name="csrf_token" value="<?php echo $csrfToken; ?>">
                </form>
                <?php endif; ?>
            </div>

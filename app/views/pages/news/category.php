...
$pageTitle = $pageTitle ?? 'Category News';
    ...
    <section class="section news-section">
        <div class="container">
            <div class="news-header">
                <h1 class="section-title"><?php echo ucfirst($category); ?> News</h1>
                <p class="section-description">
                    Latest news and updates in the <?php echo htmlspecialchars($category); ?> category.
                </p>
            </div>
                ...
                <div class="news-main">
                    ...
                    <?php else: ?>
                        <div class="empty-state">
                            ...
                            <p>Check back later for <?php echo htmlspecialchars($category); ?> news.</p>
                                ...
                                <?php foreach ($categories as $cat => $count): ?>
                                    <li class="category-item">
                                        <a href="<?php echo $baseUrl; ?>/news/category/<?php echo urlencode(strtolower($cat)); ?>" 
                                           class="category-link <?php echo strtolower($cat) === strtolower($category) ? 'active' : ''; ?>">

...
$page_title = $page_title ?? 'About Federal College of Tropical Nursing Sciences';
$page_description = $page_description ?? 'Learn about our history, mission, vision, values, and commitment to excellence in nursing education and healthcare training.';
...
/* Remove any top spacing from first content section */
.content-section:first-of-type {
    margin-top: 0 !important;
    padding-top: 0 !important;
}

/* Target the specific elements that might have margins */
#main-content,
[role="main"],
main {
    margin-top: 0 !important;
...
/* Override any existing top margins in inline styles */
[style*="margin-top"], 
[style*="padding-top"],
[style*="margin-top:"] {
    margin-top: 0 !important;
...
/* Hero Header - Fixed to remove top space */
.hero-header {
    ...
    padding: 0 0 var(--spacing-2xl) !important; /* Only bottom padding */
    position: relative;
    overflow: hidden;
    margin-top: 0 !important;
}
...
.hero-title {
    ...
    padding-top: var(--spacing-xl); /* Add some space inside the title instead */
}
...
/* First section after hero should have no top spacing */
.overview-section {

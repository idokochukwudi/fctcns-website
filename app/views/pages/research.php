...
$page_title = $page_title ?? 'Research - Federal College of Tropical Nursing Sciences';
...
// Research data (could be moved to controller later)
$researchAreas = [
    [
        'id' => 'clinical-nursing',
...
.project-status {
    position: absolute;
    top: var(--spacing-lg); /* Reduced */
    right: var(--spacing-lg); /* Reduced */
    padding: var(--spacing-xs) var(--spacing-sm);
    border-radius: var(--radius-md);
    font-size: 0.75rem;
    font-weight: 700;
...
.project-details {
    ...
    gap: var(--spacing-md);
    margin-top: var(--spacing-md); /* Reduced */
    padding-top: var(--spacing-md); /* Reduced */
    border-top: 1px solid var(--color-gray-200);
}
...
.facility-features {
    list-style: none;
    padding: 0;
    margin: 0 0 var(--spacing-md); /* Reduced */
}
...
.cta-section {
    ...
    color: var(--color-white);
    padding: var(--spacing-xl) 0; /* Reduced */
}
                ...
                <article class="research-card <?php echo e($area['icon']); ?>" data-category="<?php echo e($area['id']); ?>">
                    ...
                    <div class="research-meta">
                        <div class="research-faculty">
                            <strong>Faculty Leads:</strong> <?php echo e(implode(', ', $area['faculty'])); ?>
                        </div>
                        <div class="research-projects">
                            <svg width="16" height="16" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M12.586 4.586a2 2 0 112.828 2.828l-3 3a2 2 0 01-2.828 0 1 1 0 00-1.414 1.414 4 4 0 005.656 0l3-3a4 4 0 00-5.656-5.656l-1.5 1.5a1 1 0 101.414 1.414l1.5-1.5zm-5 5a2 2 0 012.828 0 1 1 0 101.414-1.414 4 4 0 00-5.656 0l-3 3a4 4 0 105.656 5.656l1.5-1.5a1 1 0 10-1.414-1.414l-1.5 1.5a2 2 0 11-2.828-2.828l3-3z" clip-rule="evenodd"/>
                            </svg>
                            <?php echo e($area['projects']); ?> Projects
                        </div>
                    </div>
                </article>
                <?php endforeach; ?>
    ...
    <section class="content-section publications-section" id="publications">
        <div class="container">
            ...
            <div class="publications-list">
                ...
                <article class="publication-item" data-category="<?php echo e($publication['category']); ?>">
                    <div class="publication-header">
                        <h3 class="publication-title"><?php echo e($publication['title']); ?></h3>
                        <div class="publication-authors"><?php echo e($publication['authors']); ?></div>
                    </div>
                    ...
                    <div class="publication-details">
                        ...
                        <div class="publication-detail">
                            ...
                            Vol. <?php echo e($publication['volume']); ?>, Issue <?php echo e($publication['issue']); ?>, pp. <?php echo e($publication['pages']); ?>
                        </div>
                    ...
                    <div class="publication-actions">
                        <a href="https://doi.org/<?php echo e($publication['doi']); ?>" 
                           target="_blank" 
            ...
            <div class="facilities-grid">
                ...
                <article class="facility-card">
                    ...
                    <div class="facility-contact">
                        ...
                        Contact: <?php echo e($facility['contact']); ?>
                    </div>
                </article>
                <?php endforeach; ?>
            </div>
        ...
        <div class="container">
            ...
            <div class="collaborations-grid">
                ...
                <div class="collaboration-card">
                    ...
                    <div class="collaboration-type"><?php echo e($collaboration['type']); ?></div>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <section class="content-section cta-section">
        <div class="container">
            <div class="cta-content">
                ...
                <p style="font-size: 1.125rem; opacity: 0.95; margin-bottom: var(--spacing-lg);">

<?php
/**
 * Contact Page View Template - Final Complete Code
 * 
 * @package FCTCNS
 * @version 5.6
 */
...
main.contact-page { margin-top: 0 !important; padding-top: 0 !important; }
.contact-hero { margin-top: 0 !important; padding-top: 0 !important; }
...
.contact-hero-bg {
    ...
    background-image: url('<?php echo $baseUrl; ?>/public/assets/images/contact/hero-placeholder.jpg');
}
...
.contact-hero-title { font-family: var(--font-heading); font-size: 2.8rem; font-weight: 700; color: var(--color-white-solid); text-shadow: 0 2px 6px rgba(0,0,0,0.5); }
.contact-hero-subtitle { font-size: 1.2rem; color: rgba(255,255,255,0.95); }
...
.contact-icon { font-size: 3rem; color: var(--color-primary); margin-bottom: var(--spacing-md); }
...
.success-message i { color: var(--color-accent); font-size: 4rem; margin-bottom: var(--spacing-lg); display: block; }
.error-message {
    border-left: 6px solid #dc3545;
}
.error-message i { color: #dc3545; font-size: 4rem; margin-bottom: var(--spacing-lg); display: block; }
.success-message h3, .error-message h3 { font-family: var(--font-heading); font-size: 2rem; margin-bottom: var(--spacing-md); color: var(--color-primary); }
...
.faq-question:hover { background: rgba(107, 78, 155, 0.1); }
.faq-answer {
...
.form-row { display: grid; grid-template-columns: 1fr; gap: var(--spacing-lg); }
@media (min-width: 768px) { .form-row { grid-template-columns: 1fr 1fr; } }
.form-group { margin-bottom: var(--spacing-lg); }
.form-label { display: block; margin-bottom: var(--spacing-sm); font-weight: 600; color: var(--color-primary); }
...
@media (max-width: 768px) {
    .contact-hero-content { margin-left: 5%; max-width: 90%; text-align: center; margin-top: 10vh; }
...
<main class="contact-page">
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <a href="<?php echo $baseUrl; ?>/admissions" class="btn-primary">

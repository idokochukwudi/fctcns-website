 ...
 * Admissions Page
 * 
 * Admissions information, requirements, process, and application portal integration.
 * 
 * @package FCTCNS
 * @version 2.1
 */
...
define('PAGE_TITLE', 'Admissions - FCT College of Nursing Sciences');
define('PAGE_DESCRIPTION', 'Apply for nursing programs. Learn about admission requirements, application process, and deadlines.');
define('PAGE_KEYWORDS', 'nursing admissions, apply for nursing, admission requirements, application process, nursing program application');
...
.hero-header {
    background: linear-gradient(135deg, 
        ...
        url('<?php echo $baseUrl; ?>/assets/images/admissions/hero-bg.jpg');
            ...
            <div class="portal-card">
                ...
                <div class="portal-actions">
                    <div class="portal-url">
                        <?php echo htmlspecialchars($applicationPortalUrl); ?>
                    </div>
                    
                    <a href="<?php echo $applicationPortalUrl; ?>" 
                       target="_blank" 
    ...
    <section class="content-section timeline-section" id="timeline">
        <div class="container">
            <header class="section-header">
                ...
                <p class="section-description">
                    Important dates and deadlines for the academic year <?php echo $currentYear; ?>-<?php echo $nextYear; ?>
                </p>
            </header>
            ...
            <div class="timeline-container">
                <div class="timeline-tabs" role="tablist" aria-label="Admission intake periods">
                    ...
                    <button class="timeline-tab <?php echo $index === 0 ? 'active' : ''; ?>" 
                        ...
                        <?php echo htmlspecialchars($timeline['period']); ?>
                    </button>
                    <?php endforeach; ?>
                </div>
                ...
                <div class="timeline-content <?php echo $index === 0 ? '' : 'hidden'; ?>" 
                    ...
                    <div class="timeline-period">
                        <h3><?php echo htmlspecialchars($timeline['period']); ?></h3>
                    ...
                    <div class="timeline-events">
                        ...
                        <div class="timeline-event">
                            ...
                            <div class="timeline-content-box">
                                <div class="timeline-date"><?php echo htmlspecialchars($activity['date']); ?></div>
                                <div class="timeline-activity"><?php echo htmlspecialchars($activity['activity']); ?></div>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Form validation for any forms on page
    ...
    // Utility function for hidden class
